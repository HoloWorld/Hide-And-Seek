    ...
    void Update () {
		...
		if(sw.pollSkeleton()){
			for( int ii = 0; ii < (int)Kinect.NuiSkeletonPositionIndex.Count; ii++)
			{
				...
				{
                    //ㅎㅇ코딩은 이런 방향으로 하면 되나.       
                    //                    Head.transform.position = new Vector3(0.1f, 0.2f, 0.0f);
                    //                    Head.transform.position.Set(0.1f, 0.2f, 0.0f);
                    //                  Hand_Right.transform.position = new Vector3(0.1f, 0.2f, 0.0f);
                    //                Hand_Right.transform.position.Set(0.1f, 0.2f, 0.0f);
                    RotateJoint(ii);
